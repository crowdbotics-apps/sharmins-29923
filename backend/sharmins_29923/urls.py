"""sharmins_29923 URL Configuration
...
admin.site.site_header = "sharmins"
admin.site.site_title = "sharmins Admin Portal"
admin.site.index_title = "sharmins Admin"

# swagger
api_info = openapi.Info(
    title="sharmins API",
    default_version="v1",
    description="API documentation for sharmins App",
)
